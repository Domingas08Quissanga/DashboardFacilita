        ...
        <Box className="mc-table-responsive">
            ...
            <Modal show={ blockModal } onHide={()=> setBlockModal(false)}>
                <Box className="mc-alert-modal">
                    ...
                    <Heading as="h3">Tem a certeza?!</Heading>
                    <Text as="p">Pretende bloquear esta conta de usuário?</Text>
                    <Modal.Footer>
                        <Button type="button" className="btn btn-secondary" onClick={()=> setBlockModal(false)}>não, fechar</Button>
                        <Button type="button" className="btn btn-danger" onClick={()=> setBlockModal(false)}>sim, bloquear</Button>
                    </Modal.Footer>
                </Box>
            </Modal>
        </Box>
